...
import { PeopleOutLine } from '@/app/components/icons/people-outline';
import { SchoolOutLine } from '@/app/components/icons/school-outline';
import { RocketOutline } from '@/app/components/icons/rocket-outline';
import { CarOutline } from '@/app/components/icons/car-outline';
import { BicycleOutline } from '@/app/components/icons/bicycle-outline';
import universitiesData from '@/app/components/schools.json'
...
const UniversityCard = (university= {}) => {
  const { name, alias, address, tags, pictures } = university?.university?.elevatorInfo || {};
  const { undergraduate, graduate } = university?.studentCharges || {};
  const picture = pictures?.length > 0 ? pictures[0] :''
  return (
      <div className="bg-white dark:bg-gray-900">
      <Image className="object-cover object-center w-full h-64 rounded-lg lg:h-80" src={picture} alt={name} width={800} height={400}/>
          <div className="mt-8">
              <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">{name}</h1>
              <p className="mt-2 text-gray-500 dark:text-gray-400">{alias} - {address?.city}, {address?.stateAbbreviation}</p>
              <div className="mt-4 flex flex-wrap">
                  {tags?.map(tag => (
                      <span key={tag} className="bg-blue-100 text-blue-500 mr-2 mb-2 px-2 py-1 rounded-full">{tag}</span>
                  ))}
              </div>
              <div className="mt-4">
                  <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Undergraduate Tuition</h2>
                  <p className="text-gray-500 dark:text-gray-400">In-state: ${undergraduate?.inState.tuition}</p>
                  <p className="text-gray-500 dark:text-gray-400">Out-of-state: ${undergraduate?.outOfState.tuition}</p>
              </div>
              <div className="mt-4">
                  <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Graduate Tuition</h2>
                  <p className="text-gray-500 dark:text-gray-400">In-state: ${graduate?.inState.tuition}</p>
                  <p className="text-gray-500 dark:text-gray-400">Out-of-state: ${graduate?.outOfState.tuition}</p>
              </div>
          </div>
      </div>
  );
      ...
      <section className="bg-white dark:bg-gray-900">
          <div className="container px-6 py-10 mx-auto">
              <div className="flex items-center justify-between">
                  <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Universities</h1>
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
                  {universitiesData.searchUniversity.map(university => (
                      <UniversityCard key={university.elevatorInfo.unitId} university={university} />
                  ))}
              </div>
          </div>
      </section>
...
// Header component
const TopFavourableUniversities: React.FC = () => {
  let universitiesData = [
    { "name": "University of the Cumberlands", "internationalStudents": 1430 },
    { "name": "Georgia Institute of Technology-Main Campus", "internationalStudents": 1184 },
    { "name": "Campbellsville University", "internationalStudents": 1115 },
    { "name": "New York University", "internationalStudents": 931 },
    { "name": "University of Southern California", "internationalStudents": 835 },
    { "name": "Carnegie Mellon University", "internationalStudents": 793 },
    { "name": "Columbia University in the City of New York", "internationalStudents": 708 },
    { "name": "Northeastern University", "internationalStudents": 701 },
    { "name": "New England College", "internationalStudents": 518 },
    { "name": "Northeastern University Professional Programs", "internationalStudents": 504 },
    { "name": "University of Illinois Urbana-Champaign", "internationalStudents": 482 },
    { "name": "University of Washington-Seattle Campus", "internationalStudents": 467 },
    { "name": "The University of Texas at Dallas", "internationalStudents": 458 },
    { "name": "Cornell University", "internationalStudents": 437 },
    { "name": "University at Buffalo", "internationalStudents": 428 },
    { "name": "Boston University", "internationalStudents": 395 },
    { "name": "The University of Texas at Arlington", "internationalStudents": 380 },
    { "name": "University of Michigan-Ann Arbor", "internationalStudents": 376 },
    { "name": "Pennsylvania State University-Main Campus", "internationalStudents": 374 },
    { "name": "University of Pennsylvania", "internationalStudents": 356 },
    { "name": "University of Wisconsin-Madison", "internationalStudents": 345 },
    { "name": "University of California-San Diego", "internationalStudents": 339 },
    { "name": "Purdue University-Main Campus", "internationalStudents": 337 },
    { "name": "University of California-Berkeley", "internationalStudents": 334 },
    { "name": "Rochester Institute of Technology", "internationalStudents": 323 },
    { "name": "Arizona State University Campus Immersion", "internationalStudents": 320 },
    { "name": "Maharishi International University", "internationalStudents": 319 },
    { "name": "University of Central Missouri", "internationalStudents": 306 },
    { "name": "University of North Texas", "internationalStudents": 306 },
    { "name": "University of California-Irvine", "internationalStudents": 263 }
]

  return( <section className='text-gray-600 body-font'>
  <div className='container px-5 py-24 mx-auto'>
    <div className='flex flex-col text-center w-full mb-20'>
      <h2 className='text-xs text-indigo-500 tracking-widest font-medium title-font mb-1'>EDUCATION</h2>
      <h1 className='sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900'>
        Top Universities for International Students in Computer Science
      </h1>
      <p className='lg:w-2/3 mx-auto leading-relaxed text-base'>
        Explore the top universities in the USA known for their large international student populations in Computer Science programs.
      </p>
    </div>
    <div className='flex flex-wrap'>
        {universitiesData.slice(0, 10).map((uni, index) => (
        <div className="p-4 sm:w-1/4 w-1/2">
        <h2 className="title-font font-medium sm:text-4xl text-3xl text-gray-900">{uni.internationalStudents}</h2>
        <p className="leading-relaxed">{uni.name}</p>
      </div>
...
// MajorPage component
const MajorPage: React.FC = ({ params }: { params: { slug: string } }) => {
...
const Stats = () => {
  const statsData = [
      {
          ...
          "totalStudents": "298,376",
          "internationalStudents": "38,994",
          "iconPath": <PeopleOutLine/>

      },
      {
          "degree": "Bachelor's Degree",
          "totalStudents": "109,589",
          "internationalStudents": "10,734",
          "iconPath": <BicycleOutline/>

      },
      {
          "degree": "Master's Degree",
          "totalStudents": "51,743",
          "internationalStudents": "22,926",
          "iconPath": <CarOutline/>
      ...
      },
      {
          ...
          "totalStudents": "2,735",
          "internationalStudents": "1,636",
          "iconPath": <RocketOutline/>
  ...
  return (
      <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
              <div className="flex flex-col text-center w-full mb-20">
                  <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Computer Science Enrollment in the USA, 2022</h1>
                  <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                      Explore enrollment trends in Computer Science across various degree levels in the United States.
                      These statistics highlight the international appeal and educational opportunities available.
                  </p>
              </div>
              <div className="flex flex-wrap -m-4 text-center">
                {statsData.map((stat, index) => (
                    <div key={index} className="p-4 md:w-1/4 sm:w-1/2 w-full">
                        <div className="border-2 border-gray-200 px-4 py-6 rounded-lg transform transition duration-300 hover:scale-105">
                            <div className="h-10 w-10 mb-2 inline-block">
                                {stat.iconPath}
                            </div>
                            <h2 className="title-font font-medium text-3xl text-gray-900">{stat.totalStudents}</h2>
                            <p className="leading-relaxed">{stat.degree}</p>
                            <p className="text-sm text-gray-500 mt-1">International Student: {stat.internationalStudents}</p>
                        </div>
                    </div>
                ))}
            </div>
    ...
    <>
     ...
     <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      {/* <CSJobs/> */}
        {/* <CustomerSection /> */}
        <WhoCanStudy />
        <TopFavourableUniversities />
        <Stats/>

        <Universities />
        <UniversityList universities={universitiesData.searchUniversity}/>
      <TEST />
